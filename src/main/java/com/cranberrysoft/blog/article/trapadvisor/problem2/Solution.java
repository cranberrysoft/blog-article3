...
public interface Solution {
     ...
     * @param a array of integer where each integer is greater or equal 0
     ...
     * {3,3},{2,4} sum up to n = 6 so we return 2. Please notice that we do not take into account repetitions like
